...
import {createRecord, updateRecord, getListing, getRow, deleteRecord} from '../controllers/content';
...
module.exports = (fastify: CustomFastifyInstance, opts: Object, done: Function) => {
  ...
  fastify.delete('/content/:slug/:id', {preValidation: [fastify.authenticate]}, deleteRecord)
